...
def save_fig(fig_name, fig_sub_dir, dpi=300, pad_inches=0.005, bbox_inches='tight', compress=True, png = True):
    ...
    #if png:
    #    plt.savefig(fn, format='png', dpi=700, bbox_inches=bbox_inches, pad_inches=pad_inches)
